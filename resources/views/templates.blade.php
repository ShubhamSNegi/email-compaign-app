...
<div class="container-fluid" style="margin-top:-3%">
    ...
    <nav class="col-md-2 d-none d-md-block bg-light sidebar">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
             <h1 class="h2 p-2 flex-grow-1 ">Templates</h1>
         <a class="btn btn-outline-primary" href="/createTemplate" role="button">+ Create Template</a> 
             <div class="col-lg-3" >
  ...
  <div class="row">
  @foreach($alltemplatesparameters as $templatesparameters)
  <div class="col-sm-6 col-md-4">
  <br>
  <div class="card" style="width: 18rem;">
  <div class="card-body ">
    <h3 class="card-title">{{$templatesparameters['Subject']}}</h3></div>
    <div class="card-body">
    <a href="/createcampaign?id={{$templatesparameters['id']}}" class="btn btn-primary ">Use as existing</a>
<a href="/createTemplate?id={{$templatesparameters['id']}}" class="btn btn-primary ">Edit</a>  
